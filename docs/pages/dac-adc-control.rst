...
| command  | description                                                                                   |
+==========+===============================================================================================+
| f        | searches the DAC value that corresponds to 0A current on the active channel. Always run this  |
|          | command before doing a calibration.                                                           |
+----------+-----------------------------------------------------------------------------------------------+
| g        | perform calibration on gain factors on the active channel.                                    | 
+----------+-----------------------------------------------------------------------------------------------+
| r        | runs a ramp on the active channel. The ramp min (rampMinAmp) and max (rampMaxAmp) current need|
...
|          | can be defined in the source code (rampCyclePause).                                           |
+----------+-----------------------------------------------------------------------------------------------+
...
+----------+-----------------------------------------------------------------------------------------------+
| c[x]     | changes active channel to ‘x’. x can be a number between 1 and 4. Example “c4” sets the active|
|          | channel to 4.                                                                                 |
+----------+-----------------------------------------------------------------------------------------------+
